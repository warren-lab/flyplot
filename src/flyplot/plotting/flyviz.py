...
# REVISE NECESSARY FUNCTIONS AND MAKE SURE TO PROPERLY DEFINE!
...
def contour_hrz_matrix(img):
    """
    This method is adapated from the find_fly_angle method from the package find_fly_angle
    developed by Will Dickson
    """
    # read in the image file of the fly as Grayscale
    img_fly = cv2.imread(img,cv2.IMREAD_GRAYSCALE)
    # Get basic image data
    ...
    rotated_threshold_image = cv2.rotate(rotated_threshold_image, cv2.ROTATE_90_COUNTERCLOCKWISE)
